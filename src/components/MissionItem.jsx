function MissionItem({ icon, title, description }) {
    return (
        <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-vektor-accent/40 border-2 border-vektor-primary lg:h-12 lg:w-12 hover:bg-vektor-accent/70 transition-colors duration-200">
