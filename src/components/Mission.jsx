function Mission() {
    return (
        <section id="werte" className="min-h-screen bg-white bg-gray-200">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Unsere Mission</h2>
                    <p className="text-gray-500 sm:text-xl dark:text-gray-400">Unsere Mission ist es, bodenständige und praxistaugliche KI-Lösungen für den Mittelstand zugänglich zu machen – ohne Hype, aber dafür mit klarer Strategie, fundierter Technik und rechtlicher Sicherheit.</p>
                </div>
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 border-2 border-blue-600 lg:h-12 lg:w-12 dark:bg-blue-900 dark:border-blue-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Technische Entwicklung</h3>
                        <p className="text-gray-500 dark:text-gray-400">Konzeption, Entwicklung und Integration maßgeschneiderter Machine-Learning-Lösungen – von Prozessautomatisierung bis Datenanalyse.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 border-2 border-blue-600 lg:h-12 lg:w-12 dark:bg-blue-900 dark:border-blue-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Regulatorische Sicherheit</h3>
                        <p className="text-gray-500 dark:text-gray-400">DSGVO-konforme Umsetzung Ihrer KI-Projekte, Risikoanalysen und rechtliche Begleitung für maximale Compliance.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 border-2 border-blue-600 lg:h-12 lg:w-12 dark:bg-blue-900 dark:border-blue-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Prozessautomatisierung</h3>
                        <p className="text-gray-500 dark:text-gray-400">Effizienzsteigerung durch intelligente Automatisierungen – von Predictive Maintenance bis KI-gestützter Kommunikation.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 border-2 border-blue-600 lg:h-12 lg:w-12 dark:bg-blue-900 dark:border-blue-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Datenstrategie & Infrastruktur</h3>
                        <p className="text-gray-500 dark:text-gray-400">Sichere und skalierbare Datenarchitekturen für fundierte, datengetriebene Entscheidungen in Ihrem Unternehmen.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 border-2 border-blue-600 lg:h-12 lg:w-12 dark:bg-blue-900 dark:border-blue-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Schulung & Wissenstransfer</h3>
                        <p className="text-gray-500 dark:text-gray-400">Workshops und Trainings zu Chancen, Grenzen und ethischen Aspekten der KI – praxisnah und verständlich vermittelt.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 border-2 border-blue-600 lg:h-12 lg:w-12 dark:bg-blue-900 dark:border-blue-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Partnerschaftliche Beratung</h3>
                        <p className="text-gray-500 dark:text-gray-400">Interdisziplinäre Expertise in Technik, Recht und Strategie – Beratung auf Augenhöhe für nachhaltige Erfolge.</p>
                    </div>
                </div>
            </div>
        </section>
