function Mission() {
    return (
        <section id="mission" className="min-h-screen bg-white bg-gray-200">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    ...
                    <p className="text-gray-500 sm:text-xl dark:text-gray-400">Unsere Mission ist es, bodenständige und praxistaugliche KI-Lösungen für den Mittelstand zugänglich zu machen – ohne Hype, aber mit klarer Strategie, fundierter Technik und rechtlicher Sicherheit.</p>
                </div>
